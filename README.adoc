...
| &#10003;
| streaming
| CDP 7.1.9.4 & CM 7.11.3.6 & CFM 2.1.7
| RHEL 8.8
| Postgres 14
| MIT KDC
| True
...
| CDP 7.1.9.4 & CM 7.11.3.6 & CFM 2.1.7 & EFM 2.1.2
| RHEL 8.8
| Postgres 14
| MIT KDC
| True
...
| &#10003;
| cdp-observability
| CDP 7.1.9.14 & CM 7.11.3.9 & Observability 3.4.4
| RHEL 8.8
| Postgres 14
| MIT KDC
| True
...
| 
| pvc-oc
| CDH 7.1.9.14 & CM 7.11.3.9 & PvC 1.5.4
| CENTOS 7.9
| Postgres 14
| Free IPA
| True
